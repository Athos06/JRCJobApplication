...
public class RPGTalkEditor : Editor
{
	...
	override public void OnInspectorGUI()
	{
        ...
        EditorGUILayout.LabelField("An object to indicate end of dialog");
        EditorGUILayout.PropertyField(serializedObject.FindProperty("EndDialogIcon"), GUIContent.none);
        EditorGUILayout.EndVertical ();
        ...
        EditorGUILayout.LabelField("The audio to be played when the player makes a choice:");
        EditorGUILayout.PropertyField(serializedObject.FindProperty("choiceAudio"), GUIContent.none);
        EditorGUILayout.LabelField("The audiosource  for the audio");
