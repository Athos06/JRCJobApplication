...
namespace JobApplicationGame {
    public class SceneController : MonoBehaviour
    {
        ...
        public string startingSceneName = "Lobby";
        // The name of the scene that should be loaded first.
        public string initialStartingPositionName = "EntryDoor";
        ...
        public static SceneController Instance
        {
            get
            {
                if (_instance == null) { _instance = (SceneController)FindObjectOfType(typeof(SceneController)); }
        ...
        {
            Messenger.Broadcast("OnStartSceneFadeout");
